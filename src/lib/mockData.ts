...
export const INCIDENT_TYPES = [
  ...
  'CBD 3: สัตว์กัด',
  'CBD 4: เลือดออก',
  'CBD 5: อาการทางเดินหายใจ (หอบเหนื่อย หายใจลำบาก)',
  'CBD 6: หัวใจหยุดเต้น (Cardiac arrest)',
  'CBD 7: เจ็บแน่นหน้าอก (Chest pain)',
  'CBD 8: อุดกั้นทางเดินหายใจ สำลัก ทางเดินอาหาร (อาเจียน ท้องเสีย)',
  'CBD 9: โรคเบาหวาน',
