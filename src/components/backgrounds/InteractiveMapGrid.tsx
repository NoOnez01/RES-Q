  ...
  return (
    <div className={`bg-fx-layer ${className}`} aria-hidden="true">
      ...
      <svg className="absolute inset-0 size-full opacity-30" preserveAspectRatio="none">
        <line x1="8%" y1="0" x2="8%" y2="100%" stroke="#1E3A8A" strokeWidth="2" />
        <line x1="0" y1="22%" x2="100%" y2="22%" stroke="#1E3A8A" strokeWidth="2" />
        <line x1="62%" y1="0" x2="62%" y2="100%" stroke="#0F172A" strokeWidth="1.5" />
        <line x1="0" y1="74%" x2="100%" y2="74%" stroke="#0F172A" strokeWidth="1.5" />
        <line
          ...
          strokeDasharray="6 6"
        />
        <circle cx="8%" cy="22%" r="4" fill="#1E3A8A" />
        <circle cx="62%" cy="74%" r="4" fill="#0F172A" />
      </svg>
    </div>
  )
}
