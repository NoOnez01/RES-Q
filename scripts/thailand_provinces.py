"""Thai province centroid coordinates, mirrored from src/lib/thailandProvinces.ts
(kept in sync manually -- both are small, static, and rarely change).
Used to approximate an imported NDEMS unit's location, since the source
gives no per-unit coordinates."""
